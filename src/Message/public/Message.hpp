...
#define MESSAGE  Message( std::cout, TerminalColors::GRAY   )
#define INFO     Message( std::cout, TerminalColors::CYAN   )
#define DEBUG    Message( std::cout, TerminalColors::BLUE   )
#define WARNING  Message( std::cout, TerminalColors::YELLOW )
#define ERROR    Message( std::cerr, TerminalColors::RED    )
